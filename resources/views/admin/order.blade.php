...
@section('admin-content')
    <section class="content-main">
        <div class="content-header">
            <div>
                <h2 class="content-title card-title">Placed Order List</h2>
                            ...
                            <div id="flush-collapse{{ $customerData['customer']->mobile_number }}"
                                ...
                                <div class="accordion-body">
                                    @foreach ($customerData['orders'] as $order)
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-2 col-sm-2 col-4 col-action text-end">
                                                    <a href="{{ asset('/order/storePrepraing/' . $order->id) }}"
                                                        class="btn btn-sm font-sm rounded btn-brand">
                                                        <i class="material-icons md-add"></i> Preparing
                                                    </a>
                                    ...
                                    <div
                                            ...
                                            <form action="{{ route('preparingAll') }}" method="POST">
                                                @csrf
