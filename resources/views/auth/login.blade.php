...
<head>
    ...
    <!-- Favicon -->
    <!-- <link rel="shortcut icon" type="image/x-icon" href="public/public/assets/imgs/theme/favicon.svg"> -->
    <!-- Template CSS -->
            ...
            <div class="card mx-auto card-login">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <p class="text-center mb-4">Don't have account? <a href="{{ route('register') }}">Sign up</a>
                        </p>
                </div>
            </div>
        </section>
