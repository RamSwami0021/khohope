        ...
        <nav>
            <ul class="menu-aside">
                <li class="menu-item {{ request()->is('home') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ asset('restaurants/home') }}"> <i
                ...
                <li class="menu-item has-submenu {{ request()->is('supcategory*') ? 'active' : '' }}">
                    <a class="menu-link" href="#"> <i class="icon material-icons md-shopping_cart"></i>
                        <span class="text">Super Category</span>
                    </a>
                    <div class="submenu">
                        <a href="{{ asset('/restaurants/supcategory/add') }}">Add</a>
                        <a href="{{ asset('/restaurants/supcategory/list') }}">List</a>
                    </div>
                </li>
            ...
            <ul class="menu-aside">
                <li class="menu-item">
                    <a class="menu-link" href="{{ asset('/restaurants/theme') }}"> <i
